        ...
        <div class="right_body">
            ...
            <template>
                <el-table :data="table_data" border stripe style="width: 100%">
                    <el-table-column prop="trade_date" label="交易日期" resizable min-width="100px">
                    </el-table-column>
                    ...
                    <el-table-column prop="bankname" label="收款银行" resizable min-width="100px" align="center">
                    </el-table-column>
                    ...
                    <el-table-column label="交易手续费/元" resizable min-width="110px" align="center">
                        <template scope="scope">
                            {{scope.row.trade_fee | yuan}}
                        </template>
                    </el-table-column>
                    <el-table-column label="成本手续费/元" resizable min-width="110px" align="center">
                        <template scope="scope">
                            {{scope.row.cost_fee | yuan}}
                        </template>
                    </el-table-column>
                    <el-table-column label="分润金额/元" resizable min-width="110px" align="center">
                        <template scope="scope">
                    ...
                    <el-table-column label="操作" resizable min-width="100px" align="center">
                        <template scope="scope">
                            <el-button type="info" @click="download(scope.row)">明细下载</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </template>
